...
const CategoryCard = ({ heading, description, image,slug }: TCategoryCard) => {
    const router = useRouter()
  return (
    <div onClick={() => router.push(`/books/category/${slug}`)} className="flex flex-col items-center px-4 py-5 rounded-[24px] bg-white shadow-[0px_2px_10px_0px_rgba(0,0,0,0.10)] hover:shadow-lg transition-shadow duration-300">
      <div className="mb-4 ">
